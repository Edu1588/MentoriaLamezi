...
export default function Home() {
  ...
  return (
    <div className="selection:bg-brand-orange selection:text-black font-futura text-brand-white">
      ...
      <nav className="sticky top-0 w-full z-50 liquid-glass border-x-0 border-t-0 rounded-none px-4 md:px-6 lg:px-12 py-4 md:py-5 font-futura uppercase tracking-widest h-nav-height">
        <div className="max-w-[1920px] mx-auto flex justify-between items-center h-full">
          ...
          <div className="flex items-center justify-end space-x-4 md:space-x-6 lg:space-x-8">
            <button type="button" className="clean-btn flex items-center space-x-2 lg:space-x-3 text-[10px] text-brand-gray font-bold hover:text-brand-orange uppercase tracking-widest group bg-transparent border-none">
      ...
      <a href="#" target="_blank" rel="noopener noreferrer" className="fixed bottom-[30px] right-[30px] z-[999] transition-transform duration-300 hover:scale-110">
        <div className="w-[60px] h-[60px] flex items-center justify-center bg-black/60 backdrop-blur-md rounded-full border border-white/20 border-t-white/40 shadow-[0_8px_25px_rgba(0,0,0,0.5)] group hover:bg-brand-orange">
          <MessageCircle className="w-5 h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 text-brand-white group-hover:text-black" />
        </div>
      </a>
    </div>
  );
